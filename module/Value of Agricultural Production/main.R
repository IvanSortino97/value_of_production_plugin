...
if(CheckDebug()){
  ...
  #source("~/Agriculture Production/module/Value of Agricultural Production/R fuction/gap_filler.R")
  source("~/Agriculture Production/module/Value of Agricultural Production/R fuction/discard_year_list.R")
  source("~/Agriculture Production/module/Value of Agricultural Production/R fuction/data_production.R")
  source("~/Agriculture Production/module/Value of Agricultural Production/R fuction/data_prices.R")
}
...
if (param_source_prod == "production"){ 
  ...
  dataset_prod = "aproduction"
    ...
    domain_prod = "agriculture"      #need data on disseminated domain
    dataset_prod = "aproduction"
}
...
param_country_aggr <- "country_single" # Remove to calculate country aggregates
