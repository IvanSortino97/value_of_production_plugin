...
faostat <- fread('~/Agriculture Production/module/Value of Agricultural Production/FAOSTAT/FAOSTAT_constant_USD.csv')
head(faostat)
dim(faostat)
...
View(compare[geographicAreaM49 == 226])
...
faostat <- fread('~/Agriculture Production/module/Value of Agricultural Production/FAOSTAT/FAOSTAT_constant_USD_iaggr.csv')
head(faostat)
dim(faostat)
faostat <- faostat[, c('Area Code (M49)', 'Area', 'Item Code (CPC)', 'Item', 'Year', 'Value'), with = FALSE]
setnames(faostat, old = c('Area Code (M49)', 'Area', 'Item Code (CPC)', 'Item', 'Year', 'Value'),
